...
class _HomePageState extends State<HomePage> {
      ...
      if (snap.snapshot.value != null) {
        if ((snap.snapshot.value as Map)["blockStatus"] == "no") {
          ...
          cMethods.displaySnackBar(
              "Bạn đã bị chặn ! Liên hệ admin : pm02duc@gmail.com để được mở chặn",
              context);
        }
      } else {
        FirebaseAuth.instance.signOut();
  ...
  retrieveDirectionDetails() async {
    ...
    showDialog(
      ...
      builder: (BuildContext context) =>
          LoadingDialog(messageText: "Đang tìm hướng đi..."),
    );
  ...
  resetAppNow() {
    setState(() {
      ...
      phoneNumberDriver = "";
      carDetailsDriver = "";
      tripStatusDisplay = 'ài xế đã dến điểm hẹn rùi';
    });
  }
    ...
    tripStreamSubscription =
      ...
      if ((eventSnapshot.snapshot.value as Map)["driverLocation"] != null) {
        ...
        if (status == "accepted") {
          ...
          setState(() {
            tripStatusDisplay = 'Tài xế đã dến điểm hẹn rùi';
          });
          ...
          if ((eventSnapshot.snapshot.value as Map)["fareAmount"] != null) {
            ...
            var responseFromPaymentDialog = await showDialog(
              ...
              builder: (BuildContext context) => PaymentDialog(
                  fareAmount: fareAmount.toString(), driverID: driverID),
            );
  ...
  updateFromDriverCurrentLocationToPickUp(driverCurrentLocationLatLng) async {
    if (!requestingDirectionDetailsInfo) {
      ...
      setState(() {
        tripStatusDisplay =
            "Tài xế sẽ đến trong - ${directionDetailsPickup.durationTextString}";
      });
  ...
  updateFromDriverCurrentLocationToDropOffDestination(
    ...
    if (!requestingDirectionDetailsInfo) {
      ...
      setState(() {
        tripStatusDisplay =
            "Đang đi tới điểm đến:  - ${directionDetailsPickup.durationTextString}";
      });
  ...
  noDriverAvailable() {
    showDialog(
        ...
        builder: (BuildContext context) => InfoDialog(
              title: "Không có tài xế nào xung quanh đây",
              description:
                  "Không có tài xế nào xung quanh đây. Vui lòng thử lại sau.",
            ));
  }
                      ...
                      SingleChildScrollView(
                        ...
                        child: Text(
                          Provider.of<AppInfo>(context, listen: false)
                                  ...
                                  ?.substring(9) ?? // Bắt đầu từ ký tự thứ 10
                              "Không thấy địa chỉ",
                          style: const TextStyle(
              ...
              Row(
                ...
                children: [
                  ClipOval(
                    child: Image.network(
                      photoDriver == ''
                          ? "https://random.imagecdn.app/500/500" //change tofirebase photo
                          : photoDriver,
                      width: 60,
                      height: 60,
                      fit: BoxFit.cover,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Hàm chuyển đổi tiền tệ USD sang VND
                              Text(
                                (tripDirectionDetailsInfo != null)
                                    ? (cMethods.calculateFareAmount(
                                                tripDirectionDetailsInfo!) !=
                                            null
                                        ? "${NumberFormat("#,###").format(double.parse(cMethods.calculateFareAmount(tripDirectionDetailsInfo!)) * 24000)} đ"
                                        : "")
                                    : "",
                                style: const TextStyle(
                                  fontSize: 18,
